...
## VARs
build_version = 'v1.3'
build_title = ('NST', build_version)
build_contact = 'slackertools@gmail.com'

## Main window
main_window = ThemedTk(theme='plastik')
main_window.title(build_title)
main_window.iconbitmap('images/icon.ico') #Icon
...
## Footer
#Label
footer = ttk.Label(main_window, text=build_contact,  style='footer.TLabel')
footer.grid(column=0, row=20, sticky='sw', padx=2, pady=5)
footer = ttk.Label(main_window, text=build_version,  style='footer.TLabel')
